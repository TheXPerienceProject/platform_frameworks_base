...
public class ActivityManagerService extends IActivityManager.Stub
    ...
    void enforceCallingPermission(@PermissionName String permission, String func) {
        if (checkCallingPermission(permission)
                == PackageManager.PERMISSION_GRANTED
           || com.android.internal.util.xperience.PixelPropsUtils.shouldBypassTaskPermission(Binder.getCallingUid())) {
            return;
        }
    ...
    */
    ...
    public void adjustCpusetCpus(String cgroup, long durationMillis) {
        String path = null;
        String cpuset = null;
        String bgCpuset = SystemProperties.get("persist.sys.xperience_cpu_limit_bg", "0-1");
        String fgCpuSet = SystemProperties.get("persist.sys.xperience_cpu_unlimit_ui", "0-4");
    ...
    public void setPerformanceMode(boolean enabled, String reason) {
        ...
        if (enabled) {
            ...
            if (reason.equals("sysui")) {
                String fglimit = SystemProperties.get("persist.sys.xperience_cpu_limit_ui", "0-4");
            ...
            if (reason.equals("sysui")) {
                String fgCpu = SystemProperties.get("persist.sys.xperience_cpu_fg", "0-5");
    ...
    public void boostHint(String reason, long duration) {
        ...
        if (reason != null && reason.toLowerCase().contains("launch")) {
            String fgboost = SystemProperties.get("persist.sys.xperience_cpu_unlimit_ui", "0-7");
