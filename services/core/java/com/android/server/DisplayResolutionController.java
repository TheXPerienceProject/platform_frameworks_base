...
import static mx.xperience.view.DisplayResolutionManager.FHD_WIDTH;
import static mx.xperience.view.DisplayResolutionManager.QHD_WIDTH;
import static mx.xperience.view.DisplayResolutionManager.RESTART_SYSTEMUI_ON_SWITCH;
import static mx.xperience.view.DisplayResolutionManager.SCALE;
import static mx.xperience.view.DisplayResolutionManager.TYPE_AOSP_FHD_DEFAULT;
import static mx.xperience.view.DisplayResolutionManager.TYPE_DISABLED;
import static mx.xperience.view.DisplayResolutionManager.TYPE_FORCED;
...
import mx.xperience.view.IDisplayResolutionListener;
...
public class DisplayResolutionController {
    ...
    private static final String PROP_SCALE_BOOTANIMATION =
            "persist.sys.xperience.bootanimation.scale";
    ...
    public void initSystemExService(XperienceSystemExService service) {
    ...
    public void systemReady() {
        ...
        if (overlayPkgList != null && overlayPkgList.length != 0) {
            for (String pkg : overlayPkgList) {
                if (XperienceUtils.isPackageInstalled(mContext, pkg)) {
    ...
    private void setResolutionInternal(int width, boolean onBoot) {
        ...
        applyOverlay(width == FHD_WIDTH);
        XperienceUtils.forceStopDefaultLauncher(mContext);
        if (RESTART_SYSTEMUI_ON_SWITCH) {
            XperienceUtils.restartSystemUi(mContext);
        }
