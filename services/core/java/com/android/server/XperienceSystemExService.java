...
import com.android.internal.util.xperience.FullscreenTaskStackChangeListener;
...
public class XperienceSystemExService extends SystemService {

    private static final String TAG = "XperienceSystemExService";
    ...
    public XperienceSystemExService(Context context) {
        super(context);
    ...
    private void maybeCleanClonedUser(int userId) {
        ...
        if (!hasUserApp) {
            ...
            XperienceUtils.forceStopDefaultLauncher(getContext());
        }
    }
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            XperienceSystemExService.this.onPackageRemoved(packageName);
        }
