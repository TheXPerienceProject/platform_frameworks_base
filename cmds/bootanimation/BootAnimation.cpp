...
#define TYPE_FORCED 3  // Must match mx.xperience.view.DisplayResolutionManager.TYPE_FORCED
...
status_t BootAnimation::initDisplaysAndSurfaces() {
    ...
    for (size_t displayIdx = 0; displayIdx < mDisplays.size(); displayIdx++) {
        ...
        const bool shouldScale =
                ...
                android::base::GetIntProperty("persist.sys.xpereince.bootanimation.scale", 0) == 1;
        if (shouldScale) {
...
// QTI_END: 2020-02-11: Android_UI: BootAnimation: Add bootanimation configuration prop
    ...
    const bool shouldScale =
            android::base::GetIntProperty("ro.xperience.display.resolution_switch", 0) == TYPE_FORCED &&
            android::base::GetIntProperty("persist.sys.xperience.bootanimation.scale", 0) == 1;
