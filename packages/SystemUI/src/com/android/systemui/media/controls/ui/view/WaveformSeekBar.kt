...
constructor(
    ...
    fun startWaveAnimation() {
        ...
        fadeAnimator?.cancel()
        fadeAnimator =
            ValueAnimator.ofFloat(waveAmplitudeMultiplier, 1f).apply {
                duration = 300L
                addUpdateListener {
    ...
    fun stopWaveAnimation() {
        ...
        fadeAnimator?.cancel()
        fadeAnimator =
            ValueAnimator.ofFloat(waveAmplitudeMultiplier, 0f).apply {
                duration = 300L
                addUpdateListener {
                    waveAmplitudeMultiplier = it.animatedValue as Float
                    invalidate()
    ...
    private fun calculateWaveY(
        ...
        return trackTop -
            (normalizedWave * waveHeight * envelope * waveAmplitudeMultiplier * progressLengthFactor)
    }
