...
public class NTCpuBindController {
    ...
    private static final String CPUS_PARAMS_BG_LIMIT = SystemProperties.get("persist.sys.xperience_cpu_limit_bg", "0-1");
    private static final String CPUS_PARAMS_UI_LIMIT = SystemProperties.get("persist.sys.xperience_cpu_limit_ui", "0-4");
    private static final String CPUS_PARAMS_UI_UNLIMIT = SystemProperties.get("persist.sys.xperience_cpu_unlimit_ui", "0-7");
    private static final String CPUS_PARAMS_FG_UNLIMIT = SystemProperties.get("persist.sys.xperience_cpu_fg", "0-5");
    private static final String CPUS_PARAMS_BG_UNLIMIT = SystemProperties.get("persist.sys.xperience_cpu_bg", "0-2");
    private static final String CPUS_PARAMS_BIG_CORES = SystemProperties.get("persist.sys.xperience_cpu_big", "4,5,6,7");
