...
interface IslandActions {
    ...
    val mediaControlChipModel: kotlinx.coroutines.flow.StateFlow<com.android.systemui.statusbar.quickactions.island.media.shared.model.MediaControlChipModel?>
