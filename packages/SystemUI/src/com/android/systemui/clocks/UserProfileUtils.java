...
public class UserProfileUtils {
    ...
    public static String getDeviceName() {
        ...
        String XPerienceDevice = SystemProperties.get("ro.xpe.device");

        if (marketName != null && !marketName.isEmpty()) {
            return marketName;
        } else if (modelName != null && !modelName.isEmpty()) {
            return modelName;
        } else if (XPerienceDevice != null && !XPerienceDevice.isEmpty()) {
            return XPerienceDevice;
        } else {
            Log.d(TAG, "No device name property found, using default.");
            return "XPerience Device";
        }
    }
}
